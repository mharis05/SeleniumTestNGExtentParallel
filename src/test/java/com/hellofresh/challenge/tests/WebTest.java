...
//
//import com.hellofresh.challenge.driverFactory.DriverManager;
//import com.hellofresh.challenge.driverFactory.DriverManagerFactory;
...
//        driver.findElement(By.name("email")).sendKeys(existingUserEmail);
//        driver.findElement(By.id("passwd")).sendKeys(existingUserPassword);
//        driver.findElement(By.id("SubmitLogin")).click();
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Women"))).click();
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title='Faded Short Sleeve T-shirts']/ancestor::li")));
//        WebElement yu = driver.findElement(By.xpath("//a[@title='Faded Short Sleeve T-shirts']/ancestor::li"));
//        yu.click();
